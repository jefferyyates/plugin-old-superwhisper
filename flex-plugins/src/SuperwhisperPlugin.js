...
class SuperwhisperPlugin extends FlexPlugin {
  ...
  doWhisper(e, props) {
    ...
    fetch('https://entercoaching-3739.twil.io/startCoaching', options)
      .then(resp => resp.json())
      .then(data => {
        this.whispering = true;
        this.callSid = data.callSid;
        console.log("startCoaching return: ", data);
        fetch('https://entercoaching-3739.twil.io/findCoach', options)
          .then(resp => resp.json())
  ...
  undoWhisper(e) {
    ...
    if(this.callSid) {
      ...
      fetch('https://entercoaching-3739.twil.io/stopCoaching', options)
        .then(resp => resp.json())
        .then(data => {
          fetch('https://entercoaching-3739.twil.io/findCoach', options)
            .then(resp => resp.json())
